...
from src.helper import (
    get_config, gh_api, gitea_create_repo, gitea_create_user_or_org, gitea_get_user, gitea_session, gitea_set_repo_topics,
...
def repositorySource():
    ...
    for repo in gh.get_user().get_repos():
        if not repo.fork:
            ...
            logger.info('Source Repository : {0}'.format(repo.full_name))
